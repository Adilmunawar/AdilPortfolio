...
const projects = [
        {
      title: 'Adigaze',
      description: 'Advance AI powerd candidates management system,dashboard to track applicants through the hiring pipeline extracts data of candidates to match them with jobs',
      image: '/adigaze.jpg',
