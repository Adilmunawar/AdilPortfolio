...
export function NeonOrbs() {
  ...
  return (
    <div className="fixed inset-0 -z-10 w-full h-screen overflow-hidden flex items-center justify-center bg-cyber-dark transition-colors duration-500">
      {/* Top-left orb */}
      <div
      ...
      <style jsx global>{`
        ...
        .orb-light {
          background: radial-gradient(circle at 50% 50%, var(--cyber-dark) 0%, var(--cyber-dark) 90%, transparent 100%);
          box-shadow: 
